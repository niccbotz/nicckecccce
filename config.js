...
global.sgh = 'https://github.com/niccbotz' // github
...
global.syt = '-'
global.tik = '-' // tiktok
global.tautanwa = 'https://wa.me/6285921089792'
global.wame = 'https://wa.me/6285921089792' // kalau gk punya bisa ganti pake gini wa.me/6285718828566

/*============== PAYMENT ==============*/
global.pdana = '085921089792' //dana
global.povo = '085921089792' //ovo
global.pgopay = '085921089792' //gopay
global.plinkaja = '-' //link aja
global.ppulsa = '085921089792' //telkomsel
global.ppulsa2 = '085921089792' // kalau ada kartu lain isi aja
global.psaweria = 'https://saweria.co/-'

/*============== NOMOR ==============*/
global.nomorbot = '6281515949210'
global.nomorown = '6285921089792'
global.nomorown1 = '6285921089792' //pake No Pacar lo Juga Boleh
global.namebot = 'NiccBotz'
global.nameown = 'Nicc Official'
global.nameown1 = 'Nicc Ori' //Pake Nama Pacar Lo Juga Boleh

//⫹⫺ ╳╶╼╶╶╶╶┈ ⎝ INFO BIO DATA OWN ⎞ ┈╴╴╴╴╾╴╳ ⫹⫺
global.sig = '📷 ɪɴsᴛᴀɢʀᴀᴍ : -' // ig lo
global.sigpcr = '📷 ɪɴsᴛᴀɢʀᴀᴍ : -' // ig cewek lo
/*============== Github Thanks To ==============*/
global.namagithub = 'NiccBotz' // nama github lu
...
/*============== STAFF ==============*/
global.owner = [
  ['6285921089792', 'NiccOfficial', true],
  ['6281515949210', 'NiccBotz', true],
  ['-', 'ISI KALAU ADA', true],
  ['-', 'ISI KALAU ADA', true],
  ['-', 'ISI KALAU ADA', true]
...
/*============== WATERMARK ==============*/
global.gcname = 'NiccBotz'//nama group kalian
...
global.titlebot = `⫹⫺ WhatsApp Bot | By NiccBotz`
global.packname = '☂︎ ᴄʀᴇᴀᴛᴇᴅ ʙʏ'
global.author = '              「 NiccBotz  あ」'
global.week = `${week} ${date}`
global.wibb = `${wktuwib}`
global.danied = pickRandom(["✘ 𝗘𝗿𝗼𝗿 𝟰𝟬𝟰","𝘼𝙠𝙨𝙚𝙨 𝘿𝙞𝙩𝙤𝙡𝙖𝙠","⚠️ 𝘼𝙘𝙘𝙨𝙚𝙨 𝘿𝙖𝙣𝙞𝙚𝙙 ⚠️"])

/*============== STICKER WM ==============*/
global.stickpack = 'NiccBotz'
global.stickauth = `By ©NiccOfficial`
